...
class SubmoduleRegistrar:
    def __init__(self, name = None, url=None,
        commit_id=None, relative_path=None, 
        update=False, submodules : dict | tuple | list = None
    ):
    ...
    def _register_submodule(self, submodule):
        ...
        module = tools.Module(name=name, url=url, commit_id=commit_id,
                            dst_path=dst_path)
...
submodule_registrar = SubmoduleRegistrar(submodules=(
    {"name": "triton_shared", "url": "https://github.com/microsoft/triton-shared.git", "commit_id": "5842469a16b261e45a2c67fbfc308057622b03ee"},
